...
$app->post("/checkout", function() {
    ...
    $order->save(
            0, $cart->getidcart(), $user->getiduser(), OrderStatus::EM_ABERTO, $address->getidaddress(), $cart->getvltotal()
    );
...
// DADOS DO SEU CLIENTE
    ...
    $dadosboleto["endereco1"] = $order->getdesaddress() . ", " . $order->getdesdistrict() . ", " . $order->getdesnumber();
...
$app->post("/profile/change-password", function() {
    ...
    if ($_POST['new_pass'] !== $_POST['new_pass_confirm']) {
        User::setError("A nova senha é diferente de sua confirmação.");
        header("Location: /profile/change-password");
        exit();
    }
